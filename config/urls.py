...
# Development only: serve uploads from MEDIA_ROOT. In production the default storage
# is R2 and every media URL is a presigned link to it, so nothing is served from here
# -- which is why this helper is a no-op with DEBUG=False and must stay that way.
